...
/**
 * Adapter for displaying photos in a ViewPager2 carousel.
 */
class PhotoCarouselAdapter : ListAdapter<String, PhotoCarouselAdapter.PhotoViewHolder>(PhotoDiffCallback()) {
